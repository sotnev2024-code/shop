...
- Приложение слушает **порт 8080** (порт 80 на сервере часто занят платформой). Откройте в браузере: `https://ваш-домен.online:8080` или адрес, который показывает Timeweb для приложения.
- В панели Timeweb можно привязать домен к порту 8080 или настроить проксирование.
